...
import com.rinpo.eam.layblog.utils.Maps;
...
public class R extends ConcurrentHashMap<String, Object> {
    ...
    public static Map<String, Object> ok2Map(String message, String imgUrl) {
        return Maps.hashMap("code", 0, "msg", message, "data", Maps.hashMap("src", imgUrl));
    }

    public static Map<String, Object> err2Map(String message) {
