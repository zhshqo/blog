var template = {
    ...
    '                <a href="//wuwenbin.me" target="_blank" style="color: #1E9FFF;">LayBlog</a> in 2018 ver3.' +
    '           </p>' +
    '       </div>' +
    '   </div> ' +
    '</div>'
    ...
    '                <a class="logo animated flipInX" href="/index"><i class="fa fa-graduation-cap"></i>&nbsp;笔记博客</a>' +
    ...
    '                <a href="/index" :class="{ active: home }"><i class="layui-icon">&#xe68e;</i> 主页</a>' +
    '                <a href="/profile" :class="{ active: mine }"><i class="layui-icon">&#xe6af;</i> 关于</a>' +
    '                <a href="/search" :class="{ active: search }" target="_blank"><i class="layui-icon">&#xe615;</i> 搜索</a>' +
    '            </div>' +
    '            <ul class="layui-nav layui-nav-tree layui-nav-side">' +
    '                <li class="layui-nav-item">' +
    '                   <a href="/index" :class="{ \'layui-this\': home }"><i class="layui-icon">&#xe68e;</i> 主页</a>' +
    '                </li>' +
    '                <li class="layui-nav-item">' +
    '                   <a href="/note" :class="{ \'layui-this\': note }"><i class="layui-icon">&#xe609;</i> 笔记</a>' +
    '                </li>' +
    '                <li class="layui-nav-item">' +
    '                   <a href="/profile" :class="{ \'layui-this\': mine }"><i class="layui-icon">&#xe715;</i> 关于</a>' +
    '                </li>' +
    '                <li class="layui-nav-item">' +
    '                   <a href="/search" :class="{ \'layui-this\': search }"><i class="layui-icon">&#xe615;</i> 搜索</a>' +
    '                </li>' +
    '            </ul>' +
    '        </div>' +
    '    </div>' +
    ...
    '               <a @click="tip()" href="/api/qq" class="layui-btn layui-btn-sm layui-btn-primary">' +
    ...
    '               </a>' +
    '               &nbsp;<a v-if="su !=null && su.dri == 1" href="/admin/index" target="_blank" class="layui-text">后台管理 <i class="fa fa-angle-double-right"></i> </a>' +
    '           </p>' +
    '       </div>' +
    '   </div>' +
    '</div>'
    ...
    '                                   <span><i class="fa fa-clock-o"></i> {{article.postTime}}</span>' +
    ...
    '                                   <span><i class="fa fa-eye"></i> {{article.viewsCnt}}</span>' +
    '                               </div>' +
    '                           </div>' +
    '                           <hr>' +
    ...
    '                           <div class="layui-btn" @click="emotion()"><i class="fa fa-thumbs-o-up"></i> 赞 ({{article.approveCnt}})</div>' +
    '                       </div>' +
...
Vue.component('bmy-info', {
    ...
    , data: function () {
        return {
            ...
            ,utext: "<ul>" +
            		"<li>网站名称：清's Note</li>" +
            		"<li>鸣谢项目：<a href=\"https://github.com/miyakowork/NoteBlog\" target=\"_blank\" style=\"font-style: italic;\"><i class=\"fa fa-graduation-cap\"></i>NoteBlog</a>&nbsp;</li>" +
            		"<li>QQ交流：<a target=\"_blank\" href=\"http://wpa.qq.com/msgrd?v=3&uin=165515586&site=qq&menu=yes\"><img border=\"0\" src=\"http://wpa.qq.com/pa?p=2:165515586:52\" alt=\"交流点这里\" title=\"交流点这里\"/></a>・留言：<a href=\"/message\"><i class=\"fa fa-comment-o\"></i></a></li>" +
            		"<li>前端UI：<a href=\"//layui.com\" target=\"_blank\">layui 2.2.5</a> </li>" +
            		"<li>后端架构：<a href=\"https://projects.spring.io/spring-boot/\">Spring Boot</a> 1.5.9 系列等</li>" +
            		"</ul>"
        }
    }
    , methods: {
